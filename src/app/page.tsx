  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div>
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-semibold text-cartoon-dark">Derniers posts planifiés</h2>
            <button 
              onClick={() => {
                // Récupérer l'instance du composant ScheduledPosts et appeler sa méthode loadScheduledPosts
